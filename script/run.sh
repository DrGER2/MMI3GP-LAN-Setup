...
# 20241218 drger; Reset /etc/shadow for root shell access
...
echo; echo "[ACTI] Removing root password for telnet access ..."
mv -v ${mes}/etc/shadow ${mes}/etc/shadow-orig
cp -v ${SDVAR}/shadow-LAN ${mes}/etc/shadow
